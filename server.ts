...
/*
!fs.existsSync(`${__dirname}/node_modules/app`)
  ? fs.symlinkSync(`${__dirname}/app`, `${__dirname}/node_modules/app`)
  : null;
 */
...
app.use((req: Request, res: Response, next: NextFunction) => {
  ...
  res.setHeader(
    ...
    "X-Requested-With,Content-Type,Authorization,User-Agent,X-Auth,X-Version"
  );
...
const api_url = "https://60c732bc06f3160017d28bcf.mockapi.io/api/v1/books";
const response = await fetch(api_url);
const json=const json:any json();
console.log(json);
